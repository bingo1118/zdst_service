...
//创建和初始化地图函数：
    ...
    function createIcon(json,marker_icon){
		/*var icon;
		var marker_icon = [{images:"images/marker.png"},{images:"images/marker01.png"}];
		for(var i=0;i<marker_icon.length;i++){
        	icon = new BMap.Icon(marker_icon[i], new BMap.Size(31,47),{imageOffset: new BMap.Size(-json.l,-json.t),infoWindowOffset:new BMap.Size(json.lb+5,1),offset:new BMap.Size(json.x,json.h)})//icon:{w:21,h:21,l:0,t:0,x:6,lb:5}
			return icon;
		}*/
