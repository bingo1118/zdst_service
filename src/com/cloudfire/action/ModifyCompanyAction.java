...
public class ModifyCompanyAction extends ActionSupport implements 
...
//	private static final long serialVersionUid = 1302377908285976972L; 
	...
	public void modifyCompanyInfo(){
		...
		try {
			...
			cd.modifyCompanyByC(ce);
			path = "contractinfoweb.do";
			
		} catch (Exception e) {
			e.printStackTrace();
			path = "contractinfoweb.do?methods='Modifiers'";
		}
		try {
