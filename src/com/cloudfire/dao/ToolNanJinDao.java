...
public interface ToolNanJinDao {
	...
	//	hight_set (2)高压阈值 //	low_set (2)低压阈值 //	collect_time (2)采集时间 //	send_time (2)上报时间
...
//	Low_TempSet (2)低温阈值 //	Hight_TempSet (2)高温阈值 //Low_HumiSet  低湿度 //Hight_HumiSet 高湿度   Tcollect_time (2)采集时间 //	Tsend_time (2)上报时间
