...
public class ToolEasyDaoImpl implements ToolEasyDao {
...
//		reqBody.put("extend_type", extend_type);
	...
	public void addOperator(String userid, String devMac, String context) {
		// TODO Auto-generated method stub
		String sql = "insert into operation_table(userid,devMac,operatime,content) values(?,?,?,?)";
		String operatime = GetTime.ConvertTimeByLong();
		Connection conn = DBConnectionManager.getConnection();
		PreparedStatement ps = DBConnectionManager.prepare(conn, sql);
		try {
			ps.setString(1, userid);
			ps.setString(2, devMac);
			ps.setString(3, operatime);
	...
	public void addOperator(String userid, String devMac, String context,String isOk) {
		// TODO Auto-generated method stub
		String sql = "insert into operation_table(userid,devMac,operatime,content,ifOk) values(?,?,?,?,?)";
		String operatime = GetTime.ConvertTimeByLong();
		Connection conn = DBConnectionManager.getConnection();
		PreparedStatement ps = DBConnectionManager.prepare(conn, sql);
		try {
