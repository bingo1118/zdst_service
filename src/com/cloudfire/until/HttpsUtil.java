...
public class HttpsUtil extends DefaultHttpClient {
	...
	public void initSSLConfigForTwoWay() throws Exception {
		...
		//插件路径
		String demo_base_Path = System.getProperty("catalina.base")+slash+"webapps"+slash;//System.getProperty("user.dir");
		String selfcertpath = demo_base_Path + Constant.SELFCERTPATH;
		String trustcapath = demo_base_Path + Constant.TRUSTCAPATH;
		
		if(!(new File(selfcertpath).exists())){
			selfcertpath = "D:/outgoing.CertwithKey.pkcs12";
			trustcapath = "D:/ca.jks";
		} 
//		String selfcertpath = "D:/outgoing.CertwithKey.pkcs12";
//		String trustcapath = "D:/ca.jks";
